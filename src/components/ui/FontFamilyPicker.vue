...
export default class FontFamilyPicker extends Vue {
  ...
  mounted() {
    this.fontPicker = new FontPicker(
      "AIzaSyCkLIuemWkzC0u_ARHtv_FsmYyXAETl0XM", // Google API key
  ...
  @Watch("value")
  onValueChanged() {
    const fontPickerActiveFont = this.fontPicker ? this.fontPicker.getActiveFont().family : undefined;
